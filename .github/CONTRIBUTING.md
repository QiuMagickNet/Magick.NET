...
- Please ensure the bug was not already reported by searching our [issues](https://github.com/QiuMagickNet/Magick.NET/issues).
- If you're unable to find an open issue addressing the problem, please [open a new one](https://github.com/QiuMagickNet/Magick.NET/issues/new/choose).
